...
public class Cours {
     ...
     */
    public Cours(String matiere, int numero, int credits, int moisDebut,
                 int moisFin) {
     ...
     */
    public ArrayList<Sceance> getSceances(String jourEcole, LocalTime heureDebut) {
    ...
    public void addSceances(String jourEcole, LocalTime heureDebut,
                            LocalTime heureFin, String type) {
        try {
            // On assume que les mois ont tous 4 semaines sans trop entrer dans
            // les details.
